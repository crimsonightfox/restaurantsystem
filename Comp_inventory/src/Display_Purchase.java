...
public class Display_Purchase extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED, new java.awt.Color(0, 0, 0), new java.awt.Color(255, 51, 204)));

        jTextField15.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED, new java.awt.Color(0, 0, 0), new java.awt.Color(255, 51, 204)));
        ...
        search.setFont(new java.awt.Font("Vani", 1, 14)); // NOI18N
        search.setForeground(new java.awt.Color(255, 255, 255));
        search.setText("Search");
        search.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED, new java.awt.Color(0, 0, 0), new java.awt.Color(51, 153, 255)));
        ...
        search1.setFont(new java.awt.Font("Vani", 1, 10)); // NOI18N
        search1.setForeground(new java.awt.Color(255, 255, 255));
        search1.setText("sign up user");
        search1.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED, new java.awt.Color(0, 0, 0), new java.awt.Color(51, 153, 255)));
        ...
        search2.setFont(new java.awt.Font("Vani", 1, 10)); // NOI18N
        search2.setForeground(new java.awt.Color(255, 255, 255));
        search2.setText("Log Out");
        search2.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED, new java.awt.Color(0, 0, 0), new java.awt.Color(51, 153, 255)));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(search1, javax.swing.GroupLayout.PREFERRED_SIZE, 71, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        try {
            ...
            do {
                ...
                if (cash < total) {
                    ...
                    JOptionPane.showMessageDialog(null, "PAYMENT SUCCESFUL!", null, JOptionPane.INFORMATION_MESSAGE);
                }
    ...
    private void searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchActionPerformed
        ...
        try{
            ...
            JOptionPane.showMessageDialog(null, "Enter item!", "Oops Wait...!", JOptionPane.ERROR_MESSAGE);
                ...
                rdfile = new BufferedReader( new FileReader("items.txt"));
                ...
                for( int k=0; line[k] != null; k++){
                    ...
                    if( same){
                        ...
                        jTable3.setValueAt((1000+k+1), row, 0);
                        for( int i=1; i<4; i++)
                        jTable3.setValueAt(temp[i-1], row,i);
                        row++;
                        found=true;
                    }
                }
    ...
    private void search1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_search1ActionPerformed
         SignUp1 InventoryFrame = new SignUp1();
              InventoryFrame.setVisible(true) ;        // TODO add your handling code here:
...
// TODO add your handling code here:
    ...
    private void jTextField3KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField3KeyPressed
        String haba=jTextField3.getText();
...
// TODO add your handling code here:
    ...
    private void jTextField14KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField14KeyPressed
         ...
         String haba=jTextField14.getText();
        int length = haba.length();
if(length<16 || evt.getExtendedKeyCode()==KeyEvent.VK_BACK_SPACE || evt.getExtendedKeyCode()==KeyEvent.VK_DELETE)
        {
...
// TODO add your handling code here:
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        jTextField14.setText(model.getValueAt(a,1).toString());
        jTextField6.setText(model.getValueAt(a,1).toString());
